...
import { type GEPanelStatus, GE_STATUS_ORDER as STATUS_ORDER, GE_STATUS_LABELS as STATUS_LABELS, GE_STATUS_STYLES } from "@/lib/status-styles";

export type { GEPanelStatus };
export { GE_STATUS_STYLES };
